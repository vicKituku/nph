            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@npssports.com</p>
                    <p className="text-gray-600">scouting@npssports.com</p>
                  </div>
                </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex gap-4">
                  <a
                    href="https://twitter.com/npssports"
                    target="_blank"
                  ...
                  <a
                    href="https://facebook.com/npssports"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-primary/10 p-3 rounded-lg hover:bg-primary/20 transition-colors"
                  >
                  ...
                  <a
                    href="https://instagram.com/npssports"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-primary/10 p-3 rounded-lg hover:bg-primary/20 transition-colors"
                  >
                  ...
                  <a
                    href="https://linkedin.com/company/npssports"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-primary/10 p-3 rounded-lg hover:bg-primary/20 transition-colors"
                  >
